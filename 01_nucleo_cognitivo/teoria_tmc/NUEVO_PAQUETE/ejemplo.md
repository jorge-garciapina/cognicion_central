...
NOTA COMO ES QUE LA ESTRUCTURA DE LOS EJEMPLOS ES LA MISMA QUE LA ESTRUCTURA DE LOS TEXTOS ORIGINALES, SIMPLEMENTE SE CAMBIARON LOS COMPONENTES EN EL "ESQUELETO".

ESTA FUNCIONALIDAD ES EXACTAMENTE LO QUE ESTOY PENSANDO SOBRE ESTE PAQUETE COGNITIVO: EL PAQUETE SE ENCARGARÁ DE EXTRAER LA ESTRUCTURA DE LOS TEXTOS Y DESPUÉS PERMITIRÁ REPLICARLA CON OTROS COMPONENTES DISTINTOS. AUNQUE EN ESTOS EJEMPLOS SE DA UNA IDEA MUY SUPERFICIAL, EN EL PAQUETE SE BUSCARÁ QUE ENCUENTRE LA ESTRUCTURA COMPLETA CON COSAS COMO, POR EJEMPLO, LA SECUENCIA, O LAS REDES SEMÁNTICAS O COGNITIVAS.

ESTO NO ESTÁ MUY ALEJADO DE LO QUE YA SE PROPONE EN EL PAQUETE, CONSIDERALO UN REFINAMIENTO.

LA RAZÓN POR LA QUE USO "DINÁMICO" SE DEBE A QUE YA NO SE BUSCARÁ CREAR UNA ÚNICA ESTRUCTURA QUE DEBE ABARCAR TODOS LOS TEXTOS, SINO QUE LAS ESTRUCTURAS SERÁN CREADAS CON CADA TEXTO RECIBIDO. LA VENTAJA DE ESTO ES QUE SE PODRÁ UTILIZAR CUALQUIER TEXTO Y REPLICAR SU ESTRUCTURA, DESPUÉS SE PODRÁ ENVIAR INFORMACIÓN (ARTÍCULOS, GUIONES, ETC -TODO LO QUE YA MENCIONÉ ARRIBA-) Y EL PAQUETE COGNITIVO SE ENCARGARÁ DE EXTRAER LA INFORMACIÓN NECESARIA PARA ADAPTARSE A LA ESTRUCTURA QUE YA SE TIENE.

GUARDA ESTO COMO PRIORIDAD DE DISEÑO.
